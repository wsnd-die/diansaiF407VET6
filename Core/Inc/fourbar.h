 ...
 *   前馈补偿参数（可在线调）
 * ====================================================================== */
#define FF_FRICTION_BASE     5.0f    /**< 基础库伦摩擦（脉冲） */
#define FF_FRICTION_LEARN    0.03f   /**< 自适应摩擦学习率 */
#define FF_SPD_THRESHOLD     10.0f   /**< 摩擦前馈启用的最低 speed 阈值 */
#define FF_STEADY_POS        3       /**< 自适应学习所需的稳态位置阈值 */
#define FF_MAX_ADAPTIVE      30.0f   /**< 自适应摩擦上限（防跑飞） */
